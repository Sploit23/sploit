...
export const TypeId: TypeId = "~@sploit-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@sploit-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@sploit-ai/effect-sqlite-node/NodeSqliteClient")

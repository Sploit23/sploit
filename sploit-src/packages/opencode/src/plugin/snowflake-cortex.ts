        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              headers.set("User-Agent", `sploit/${InstallationVersion}`)
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. Sploit will capture the OAuth callback and store the bearer token automatically.",

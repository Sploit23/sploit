...
import { httpClient, path } from "@sploit-ai/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/SkillDiscovery") {}
      ...
      const dirs = yield* Effect.forEach(
        ...
        (skill) =>
          Effect.gen(function* () {
            ...
            const versionFile = path.join(root, ".sploit-version")
            ...
            if (version === undefined || current === version) {
              ...
              yield* Effect.gen(function* () {
                ...
                yield* fs.writeFileString(path.join(staging, ".sploit-version"), version)

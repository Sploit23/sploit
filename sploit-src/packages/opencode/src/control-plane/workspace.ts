...
import { EventSequenceTable, EventTable } from "@sploit-ai/core/event/sql"
...
import { WorkspaceEvent } from "@sploit-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/Workspace") {}

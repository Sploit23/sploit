...
import { AccountStateTable, AccountTable } from "@sploit-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/AccountRepo") {}

...
import { path } from "@sploit-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@sploit-ai/core/project"
...
import { WorktreeEvent } from "@sploit-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `sploit/${name}`

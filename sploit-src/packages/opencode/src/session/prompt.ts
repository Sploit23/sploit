...
import { MAX_STEPS_PROMPT } from "@sploit-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@sploit-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/SessionPrompt") {}
      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          if (
            ...
            const verdict = yield* SessionReminders.enforceTurnVerification({
              messages: msgs,
              session,
              sessionID,
            }).pipe(

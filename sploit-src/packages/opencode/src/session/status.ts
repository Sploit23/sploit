...
import { SessionStatusEvent } from "@sploit-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/SessionStatus") {}

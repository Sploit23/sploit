...
import { buildPrompt } from "@sploit-ai/core/session/compaction"
import { SessionCompactionEvent } from "@sploit-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/SessionCompaction") {}

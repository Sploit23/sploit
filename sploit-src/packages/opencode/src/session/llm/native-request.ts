import type { JsonSchema, LLMRequest, ProviderMetadata } from "@sploit-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@sploit-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @sploit-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({

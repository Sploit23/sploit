...
import { PermissionV1 } from "@sploit-ai/core/v1/permission"
import { Slug } from "@sploit-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@sploit-ai/llm"
...
import { locationServiceMapLayer } from "@sploit-ai/core/location-services"
...
import { PartTable, SessionTable } from "@sploit-ai/core/session/sql"
...
import { WorkspaceV2 } from "@sploit-ai/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@sploit-ai/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@sploit-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".sploit", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@sploit/Session") {}

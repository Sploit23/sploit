...
import { llmClient } from "@sploit-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@sploit-ai/llm"
import { LLMClient } from "@sploit-ai/llm/route"
import type { LLMClientService } from "@sploit-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @sploit-ai/llm. It

...
import type { Event, GlobalEvent, OpencodeClient } from "@sploit-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@sploit/RunStreamTransport") {}

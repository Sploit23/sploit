...
//
// The saved variant persists across sessions in ~/.local/state/sploit/model.json
...
class Service extends Context.Service<Service, VariantService>()("@sploit/RunVariant") {}

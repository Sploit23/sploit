// Shared type vocabulary for the direct interactive mode (`sploit --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@sploit-ai/sdk/v2"

...
import { normalizePromptContent } from "@sploit-ai/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@sploit-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Sploit" } satisfies SlashOption,
    ]

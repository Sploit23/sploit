...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@sploit-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/ToolRegistry") {}

...
import { AbsolutePath, type DeepMutable } from "@sploit-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".sploit", "plans", "*.md")]: "allow",

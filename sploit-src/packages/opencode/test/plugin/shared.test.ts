...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@sploit/acme")).toEqual({
      pkg: "@sploit/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@sploit/acme@1.0.0")).toEqual({
      pkg: "@sploit/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@sploit/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@sploit/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@sploit/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@sploit/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })

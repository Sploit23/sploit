...
import { createOpencodeClient } from "@sploit-ai/sdk/v2/client"
import { ServerAuth } from "@sploit-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/cli/Daemon") {}

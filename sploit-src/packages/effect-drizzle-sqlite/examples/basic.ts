...
class Database extends Context.Service<Database, DatabaseShape>()("@sploit/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@sploit/example/UserStore") {

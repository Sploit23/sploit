...
import defaultSoundPath from "@sploit-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@sploit-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@sploit-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@sploit-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@sploit-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@sploit-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "sploit"
const DEFAULT_PACK_ID = "sploit.default"

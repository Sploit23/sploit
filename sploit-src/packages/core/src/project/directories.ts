...
import type { EffectDrizzleSqlite } from "@sploit-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/ProjectDirectories") {}

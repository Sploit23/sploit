...
import { Event } from "@sploit-ai/schema/project-directories"
import { ProjectCopy } from "@sploit-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/ProjectCopy") {}

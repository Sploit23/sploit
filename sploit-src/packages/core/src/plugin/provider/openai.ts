...
import type { IntegrationOAuthMethodRegistration } from "@sploit-ai/plugin/v2/effect/integration"
import { define } from "@sploit-ai/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `sploit/${InstallationVersion}` }
}

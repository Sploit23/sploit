...
import type { Data, Definition, Payload } from "@sploit-ai/schema/event"
...
import { Durable } from "@sploit-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@sploit-ai/schema/event").ID
export type { Data, Definition, Payload } from "@sploit-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/Event") {}

...
import { Entry, FileSystem, FindInput, Match } from "@sploit-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@sploit-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/v2/FileSystem") {}

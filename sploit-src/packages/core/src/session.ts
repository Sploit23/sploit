...
import { ListAnchor } from "@sploit-ai/schema/session"
...
import { SessionDurable } from "@sploit-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/v2/Session") {}

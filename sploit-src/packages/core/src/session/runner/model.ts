...
import { type Model } from "@sploit-ai/llm"
import * as AnthropicMessages from "@sploit-ai/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@sploit-ai/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@sploit-ai/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@sploit-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@sploit/v2/SessionRunnerModel") {}

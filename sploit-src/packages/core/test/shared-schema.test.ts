...
import { SessionV2 } from "@sploit-ai/core/session"
import { Agent } from "@sploit-ai/schema/agent"
import { Location } from "@sploit-ai/schema/location"
import { Model } from "@sploit-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@sploit-ai/schema/prompt"
import { Provider } from "@sploit-ai/schema/provider"
import { Project } from "@sploit-ai/schema/project"
import { ProjectDirectories } from "@sploit-ai/schema/project-directories"
import { PermissionV1 } from "@sploit-ai/schema/permission-v1"
import { Session } from "@sploit-ai/schema/session"
import { SessionInput } from "@sploit-ai/schema/session-input"
import { SessionMessage } from "@sploit-ai/schema/session-message"
import { Workspace } from "@sploit-ai/schema/workspace"
import { Command } from "@sploit-ai/schema/command"
import { Connection } from "@sploit-ai/schema/connection"
import { Credential } from "@sploit-ai/schema/credential"
import { FileSystem } from "@sploit-ai/schema/filesystem"
import { Integration } from "@sploit-ai/schema/integration"
import { LLM } from "@sploit-ai/schema/llm"
import { Permission } from "@sploit-ai/schema/permission"
import { Plugin } from "@sploit-ai/schema/plugin"
import { Pty } from "@sploit-ai/schema/pty"
import { Reference } from "@sploit-ai/schema/reference"
import { SessionTodo } from "@sploit-ai/schema/session-todo"
import { Skill } from "@sploit-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@sploit-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@sploit-ai/core/command"),
    import("@sploit-ai/core/integration/connection"),
    import("@sploit-ai/core/credential"),
    import("@sploit-ai/core/filesystem"),
    import("@sploit-ai/core/integration"),
    import("@sploit-ai/core/location"),
    import("@sploit-ai/llm"),
    import("@sploit-ai/core/permission"),
    import("@sploit-ai/core/v1/permission"),
    import("@sploit-ai/core/project/copy"),
    import("@sploit-ai/core/pty"),
    import("@sploit-ai/core/project/schema"),
    import("@sploit-ai/core/reference"),
    import("@sploit-ai/core/session/input"),
    import("@sploit-ai/core/session/message"),
    import("@sploit-ai/core/session/todo"),
    import("@sploit-ai/core/session/prompt"),
    import("@sploit-ai/core/skill"),
    import("@sploit-ai/core/v2-schema"),
    import("@sploit-ai/core/schema"),
    import("@sploit-ai/core/workspace"),
  ])

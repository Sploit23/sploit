import type { PluginContext } from "@sploit-ai/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@sploit-ai/sdk/v2/types"
